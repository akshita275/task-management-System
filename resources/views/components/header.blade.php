    ...
    <div class="sidebar">
      ...
      <nav class="mt-3">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="{{route('adminindex')}}" class="nav-link {{Request::routeIs('adminindex') ? 'active' : ''}}">
          ...
          <li class="nav-item {{ Request::routeIs('users.*','archiveUsers') ? 'menu-open' : '' }}">
              <a href="#" class="nav-link">
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                  <a href="{{route('archiveUsers')}}" class="nav-link {{ Request::routeIs('archiveUsers') ? 'active' : '' }}">
                    <i class="nav-icon far fa-eye right"></i>
                    <p>Archived users</p>
                  </a>
                </li>
