<x-guest-layout>
    ...
    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
        ...
        <div class="mt-4">
            ...
            <x-type-dropdown class="block mt-1 w-full" name="type"/>
        ...
        <!-- profile_picture -->
        <div>
            <x-input-label for="profile_picture" :value="__('upload image/Profile')" />
            <input type="file" name="profile_picture" class="block mt-1 w-full" >
            <x-input-error :messages="$errors->get('name')" class="mt-2" />
        </div>
